...
void KratosDropletDynamicsApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE( DISTANCE_GRADIENT_DIVERGENCE)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS( DISTANCE_GRADIENT_SIZE_GRADIENT)
    KRATOS_REGISTER_VARIABLE(INTERSECTION_LENGTH_2D)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ELEMENT_CUT_NORMAL)
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(ELEMENT_CUT_NORMAL_AVERAGED)
    // AW 14.5: end of added lines
    /////////////////////////////
